...
@section('content')
    ...
    <div class="col-lg-12">
        <div class="col-lg-3">
            <div class="col-lg-12 sideInfo-item">
                <div class="sideInfo-title">What Services do we offer?</div>
                <br/>
                We offer a variety of services though please take note that these services have no fixed prices.
                For more information, kindly contact us via email or our company phone number
                <a class="btn btn-primary btn-sm collapsable" data-toggle="collapse" data-target="#demo2">See more</a>

                <div id="demo2" class="collapse">
                    <br/>
                    <strong style="color: orange">Services offered:</strong>
                    <ul>
                        <li>Installation of fire alarm</li>
                        <li>Seminar about fire fighting and earthquake</li>
                        <li>Refilling of HCFC 5, 10, 20, 50lbs</li>
                        <li>Refilling of dry chemical 5,10,20,50,100,200 lbs</li>
                        <li>Refilling of FFF 5,10,20,50,100,200lbs</li>
                    </ul>
                </div>
            </div>
        </div>
